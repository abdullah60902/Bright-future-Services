...
import logo from "@/public/logo1.jpg"; // Logo
  ...
  useEffect(() => {
    ...
    const handleClickOutside = (event: MouseEvent) => {
      ...
      if (
        ...
        target.tagName !== "BUTTON" // Ignore emoji buttons
      ) {
  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="fixed bottom-20 cursor-pointer right-5 z-50 flex items-center justify-center bg-green-500 text-white w-14 h-14 rounded-full shadow-lg hover:bg-green-600 transition-transform transform hover:scale-105 bounce-animation"
        ...
        >
          ...
          <div className="bg-[#075e54] text-white p-3 rounded-t-lg flex justify-between items-center">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm font-bold">bright future </p>
